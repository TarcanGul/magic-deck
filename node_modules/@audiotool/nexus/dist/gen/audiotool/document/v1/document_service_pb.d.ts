 ...
 */
export declare class GetCommitIndexRangeRequest extends Message<GetCommitIndexRangeRequest> {
    /**
 ...
 */
export declare class RenderAudioRequest extends Message<RenderAudioRequest> {
    /**
