...
export declare const DocumentService: {
    readonly typeName: "audiotool.document.v1.DocumentService";
    readonly methods: {
        /**
        ...
        readonly attach: {
            ...
            readonly I: typeof AttachRequest;
            readonly O: typeof AttachResponse;
        ...
        readonly applyTransactions: {
            readonly name: "ApplyTransactions";
            readonly I: typeof ApplyTransactionsRequest;
            readonly O: typeof ApplyTransactionsResponse;
         ...
         */
        readonly getWasm: {
            readonly name: "GetWasm";
            readonly I: typeof GetWasmRequest;
            readonly O: typeof GetWasmResponse;
            readonly kind: MethodKind.Unary;
        };
        /**
         ...
         */
        readonly getWasmExec: {
            readonly name: "GetWasmExec";
            readonly I: typeof GetWasmExecRequest;
            readonly O: typeof GetWasmExecResponse;
            readonly kind: MethodKind.Unary;
        };
        /**
         ...
         */
        readonly getClientStats: {
            readonly name: "GetClientStats";
            readonly I: typeof GetClientStatsRequest;
            readonly O: typeof GetClientStatsResponse;
            readonly kind: MethodKind.Unary;
        };
        /**
        ...
        readonly getTime: {
            ...
            readonly I: typeof GetTimeRequest;
            readonly O: typeof GetTimeResponse;
            readonly kind: MethodKind.Unary;
        };
        /**
        ...
        readonly attachMetadata: {
            readonly name: "AttachMetadata";
            readonly I: typeof AttachMetadataRequest;
            readonly O: typeof AttachMetadataResponse;
            readonly kind: MethodKind.ServerStreaming;
        };
        /**
        ...
        readonly putMetadata: {
            readonly name: "PutMetadata";
            readonly I: typeof PutMetadataRequest;
            readonly O: typeof PutMetadataResponse;
            readonly kind: MethodKind.Unary;
        };
        /**
         ...
         */
        readonly getCommitIndexRange: {
            readonly name: "GetCommitIndexRange";
            readonly I: typeof GetCommitIndexRangeRequest;
            readonly O: typeof GetCommitIndexRangeResponse;
            readonly kind: MethodKind.Unary;
        };
        /**
        ...
        readonly renderAudio: {
            readonly name: "RenderAudio";
            readonly I: typeof RenderAudioRequest;
