import { BinaryReadOptions, FieldList, JsonReadOptions, JsonValue, PartialMessage, PlainMessage, Duration, Message, proto3, Timestamp } from '@bufbuild/protobuf';
 ...
 */
export declare enum TrackLicense {
    /**
     * Unspecified license.
     *
...
export declare class Project extends Message<Project> {
     ...
     */
    copyOfProjectCommitIndex: bigint;
    /**
     * The Project name.
     *
