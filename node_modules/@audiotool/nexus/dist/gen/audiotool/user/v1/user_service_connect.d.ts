...
export declare const UserService: {
    readonly typeName: "audiotool.user.v1.UserService";
    readonly methods: {
        /**
         * Lists the users.
         *
         ...
         */
        readonly batchGetUsers: {
            readonly name: "BatchGetUsers";
            readonly I: typeof BatchGetUsersRequest;
            readonly O: typeof BatchGetUsersResponse;
            readonly kind: MethodKind.Unary;
        };
    };
};
