 ...
 */
export declare class ListSampleProcessesRequest extends Message<ListSampleProcessesRequest> {
 ...
 */
export declare class SampleProcess extends Message<SampleProcess> {
    /**
 ...
 */
export declare class ListSampleProcessesResponse extends Message<ListSampleProcessesResponse> {
    /**
 ...
 */
export declare class CancelSampleUploadRequest extends Message<CancelSampleUploadRequest> {
    /**
 ...
 */
export declare class CancelSampleUploadResponse extends Message<CancelSampleUploadResponse> {
