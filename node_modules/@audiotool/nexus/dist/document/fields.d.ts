...
export type PrimitiveType = number | bigint | string | boolean | NexusLocation | Uint8Array;
/**
...
export declare const primitiveEquals: (a: PrimitiveType, b: PrimitiveType) => boolean;
